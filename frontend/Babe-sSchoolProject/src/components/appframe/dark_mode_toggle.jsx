...
import { toggleDarkMode } from "../../helpers/display_mode_helpers";
...
const DarkModeToggle = () => {
  ...
  return (
    <button
      className="darkmode-toggle btn h-8 w-8 min-h-8 rounded-full p-0 m-1 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"

      ...
      <div className="grid md:grid-cols-2 relative gap-5 px-3">
        <div className="h-[540px] relative rounded-2xl overflow-hidden">
          <div className="hidden md:flex justify-center items-center w-full h-full">
            <img
              src={"http://localhost:3001/rooms/" + photos?.[0]?.url}
          ...
          <div className="md:hidden flex justify-center items-center w-full h-full">
            <img
              src={
                "http://localhost:3001/rooms/" + photos?.[currenPhotoIndex]?.url
              }
              alt={`Room Photo ${currenPhotoIndex + 1}`}
              className="img"
              width={150}
          ...
          {displayPhotos?.map((photo, index) => (
            ...
            >
              <img
                width={150}
                height={150}
                src={"http://localhost:3001/rooms/" + photo?.url}
            ...
            >
              <img
                ...
                src={
                  ...
                  photos[maximumVisiblePhotos - 1].url
                }
